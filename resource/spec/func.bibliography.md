...
```html
<p>
    <a class="mention" href="#Bibliography-12-Rules">(Peterson, 2018)</a>
    <a class="mention" href="#Bibliography-Lateral-Thinking">(de Bono, 1970)</a>
    <a class="mention" href="#Bibliography-Good-Omens">(Pratchett & Gaiman, 1990)</a>
    <a class="mention" href="#Bibliography-My-Lady-Jane">(Hand et al., 2016)</a>
</p>
```
